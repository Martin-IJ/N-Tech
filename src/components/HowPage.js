    ...
    <div className="bg-white py-20 overflow-hidden">
      <div className="max-w-[85%] w-full m-auto text-center space-y-7">
        <h1 className="text-5xl">
          How It Is <span className="textGradient">Going</span>
        </h1>
        ...
        <div className="relative isolate overflow-hidden flex flex-wrap gap-10 justify-between">
          ...
          <motion.div
            ...
            className="group flex items-center lg:flex-col gap-7"
          >
            <h2 className="text-[#BCBCBC] text-4xl font-semibold">01</h2>
            <div className="border-2 border-[#D016D7] inline-flex p-4 rounded-full group-hover:text-[#D016D7] text-4xl">
              <IoBulbOutline />
            </div>
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.4 }}
            className="group flex items-center lg:flex-col gap-7 lg:mt-40"
          >
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.4 }}
            className="group flex items-center lg:flex-col gap-7 lg:mt-10"
          >
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.4 }}
            className="group flex items-center lg:flex-col gap-7 lg:mt-36"
          >
